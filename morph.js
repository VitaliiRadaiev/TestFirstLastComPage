...
function (t, e) {
        ...
        function reverseSegment(t) {
                var e, n = 0;
                for (t.reverse(); n < t.length; n += 2) e = t[n],
                t[n] = t[n + 1],
                t[n + 1] = e;
        ...
        function convertToPath(t, e) {
                ...
                return "path" !== T && t.getBBox ? (s = function _createPath(t, e) {
                        var n, r = document.createElementNS("http://www.w3.org/2000/svg", "path"),
                                ...
                                a = o.length;
                        for (e = "," + e + ","; - 1 < --a;) n = o[a].nodeName.toLowerCase(),
        ...
        function arcToSegment(t, e, n, r, o, a, i, s, h) {
                if (t !== s || e !== h) {
                        ...
                        var I, L = Math.ceil(D(Y) / (f / 4)),
                                ...
                                k = g * -r,
                                q = c * r;
                        for (I = 0; I < L; I++) P = B(o = j + I * F),
                        m = H(o),
                        A = B(o += F),
                        R = H(o),
                        W.push(P - X * m, m + X * P, A + X * R, R - X * A, A, R);
                        for (I = 0; I < W.length; I += 2) P = W[I],
                        m = W[I + 1],
                        W[I] = P * G + m * k + N,
                        W[I + 1] = P * U + m * q + z;
                        return W[I - 2] = s,
        ...
        function stringToRawPath(t) {
                ...
                if (!t || !isNaN(P[0]) || isNaN(P[1])) return console.log(x),
                m;
                for (e = 0; e < w; e++) if (f = a, isNaN(P[e]) ? i = (a = P[e].toUpperCase()) !== P[e] : e--, r = +P[e + 1], o = +P[e + 2], i && (r += _, o += v), e || (h = r, l = o), "M" === a) s && (s.length < 8 ? --m.length : y += s.length),
                _ = h = r,
                v = l = o,
                s = [r, o],
                m.push(s),
                ...
                g = v,
                "C" !== f && "S" !== f || (c += _ - s[s.length - 4], g += v - s[s.length - 3]),
                i || (_ = v = 0),
                s.push(c, g, r, o, _ += 1 * P[e + 3], v += 1 * P[e + 4]),
                e += 4;
                else if ("Q" === a) c = _ + 2 / 3 * (r - _),
                g = v + 2 / 3 * (o - v),
                i || (_ = v = 0),
                _ += 1 * P[e + 3],
                v += 1 * P[e + 4],
                ...
                e += 4;
                else if ("T" === a) c = _ - s[s.length - 4],
                g = v - s[s.length - 3],
                s.push(_ + c, v + g, r + 2 / 3 * (_ + 1.5 * c - r), o + 2 / 3 * (v + 1.5 * g - o), _ = r, v = o),
                e += 2;
                else if ("H" === a) Ac(_, v, _ = r, v),
                e += 1;
                else if ("V" === a) Ac(_, v, _, v = r + (i ? v - _ : 0)),
                e += 1;
                else if ("L" === a || "Z" === a)"Z" === a && (r = h, o = l, s.closed = !0),
                ("L" === a || .5 < D(_ - r) || .5 < D(v - o)) && (Ac(_, v, r, o), "L" === a && (e += 2)),
                _ = r,
                v = o;
                else if ("A" === a) {
                ...
                return (e = s.length) < 6 ? (m.pop(), e = 0) : s[0] === s[e - 2] && s[1] === s[e - 1] && (s.closed = !0),
                m.totalPoints = y + e,
                m
        }
        ...
        function V(t) {
                var e, n, r, o = t.length,
                        ...
                        s = t[1],
                        h = s;
                for (r = 6; r < o; r += 6) a < (e = t[r]) ? a = e : e < i && (i = e),
        ...
        function W(t, e) {
                void 0 === e && (e = 3);
                for (var n, r, o, a, i, s, h, l, c, g, p, f, u, d, P, m, _ = t.length, v = t[0][0], w = v, y = t[0][1], x = y, M = 1 / e; - 1 < --_;) for (n = (i = t[_]).length, a = 6; a < n; a += 6) for (c = i[a], g = i[a + 1], p = i[a + 2] - c, d = i[a + 3] - g, f = i[a + 4] - c, P = i[a + 5] - g, u = i[a + 6] - c, m = i[a + 7] - g, s = e; - 1 < --s;) v < (r = ((h = M * s) * h * u + 3 * (l = 1 - h) * (h * f + l * p)) * h + c) ? v = r : r < w && (w = r),
        ...
        function $(t, e, n, r, o) {
                var a, i, s, h, l = t.length,
                        c = 0,
                        g = l - 2;
                for (n *= 6, i = 0; i < l; i += 6) h = t[a = (i + n) % g] - (e[i] - r),
                s = t[1 + a] - (e[i + 1] - o),
                c += v(s * s + h * h);
                return c
        }
        ...
        function aa(t, e, n) {
                for (var r, o, a, i, s, h, l = t.length, c = 1e20, g = 0, p = 0; - 1 < --l;) for (h = (r = t[l]).length, s = 0; s < h; s += 6) o = r[s] - e,
                a = r[s + 1] - n,
        ...
        function ba(t, e, n, r, o, a) {
                var i, s, h, l, c = e.length,
                        ...
                        u = t.centerX + o,
                        d = t.centerY + a;
                for (i = n; i < c && !((e[i].size || V(e[i])) < p); i++) s = e[i].centerX - u,
                h = e[i].centerY - d,
        ...
        function ca(t, e) {
                var n, r, o, a, i, s, h, l, c, g, p, f, u, d, P = 0,
                        m = t.length,
                        _ = e / ((m - 2) / 6);
                for (u = 2; u < m; u += 6) for (P += _;.999999 < P;) n = t[u - 2],
                r = t[u - 1],
                o = t[u],
                a = t[u + 1],
                i = t[u + 2],
        ...
        function ga(t, e) {
                ...
                for (n = .5 * e / (.5 * (o = t.length) - 1), r = 0; r < o - 2; r += 2) {
                        if (l += n, s = parseFloat(t[r + 2]), h = parseFloat(t[r + 3]), .999999 < l) for (i = 1 / (Math.floor(l) + 1), a = 1;.999999 < l;) p += (c + (s - c) * i * a).toFixed(2) + "," + (g + (h - g) * i * a).toFixed(2) + " ",
                        l--,
                        a++;
                        p += s + "," + h + " ",
                        c = s,
                ...
                return isNaN(e) ? ha : function (t) {
                        ...
                        t[1] = function _offsetPoints(t, e) {
                                ...
                                var n, r, o, a = t.match(L) || [],
                                        i = a.length,
                                        s = "";
                                for (n = "reverse" === e ? (r = i - 1, -2) : (r = (2 * (parseInt(e, 10) || 0) + 1 + 100 * i) % i, 2), o = 0; o < i; o += 2) s += a[r - 1] + "," + a[r] + " ",
                                r = (r + n) % i;
                                return s
                        }(t[1], parseInt(e, 10))
                }
        ...
        function ka(t, e) {
                for (var n, r, o, a, i, s, h, l, c, g, p, f, u = t.length, d = .2 * (e || 1); - 1 < --u;) {
                        for (p = (r = t[u]).isSmooth = r.isSmooth || [0, 0, 0, 0], f = r.smoothData = r.smoothData || [0, 0, 0, 0], p.length = 4, l = r.length - 2, h = 6; h < l; h += 6) o = r[h] - r[h - 2],
                        a = r[h + 1] - r[h - 1],
                        i = r[h + 2] - r[h],
                        s = r[h + 3] - r[h + 1],
                        c = w(a, o),
                        g = w(s, i),
                        (n = Math.abs(c - g) < d) && (f[h - 2] = c, f[h + 2] = g, f[h - 1] = v(o * o + a * a), f[h + 3] = v(i * i + s * s)),
                        p.push(n, n, 0, 0, n, n);
        ...
        function pa(t) {
                ...
                a && n ? (C = a.utils.toArray, n.prototype._tweenRotation = oa, I = 1) : t && M("Please gsap.registerPlugin(MorphSVGPlugin)")
        }
        var a, C, j, I, n, w = Math.atan2,
                ...
                k = function (t) {
                        ...
                        for (setTimeout(function checkWarn() {
                                if (e) if ("loading" === document.readyState || "interactive" === document.readyState) document.addEventListener("readystatechange", checkWarn);
                                else {
                ...
                J = {
                        ...
                        init: function init(t, e, n, r, o) {
                                if (I || pa(1), !e) return M("invalid shape"),
                                !1;
                                ...
                                if (l = "POLYLINE" === (a = (t.nodeName + "").toUpperCase()) || "POLYGON" === a, "PATH" !== a && !l && !e.prop) return M("Cannot morph a <" + a + "> element. " + q),
                                !1;
                                if (i = "PATH" === a ? "d" : "points", !e.prop && !z(t.setAttribute)) return !1;
                                if (h = function _parseShape(t, e, n) {
                                        var r, o;
                                        return (!("string" == typeof t) || F.test(t) || (t.match(L) || []).length < 3) && ((r = C(t)[0]) ? (o = (r.nodeName + "").toUpperCase(), e && "PATH" !== o && (r = convertToPath(r, !1), o = "PATH"), t = r.getAttribute("PATH" === o ? "d" : "points") || "", r === n && (t = r.getAttributeNS(null, "data-original") || t)) : (M("WARNING: invalid morph to: " + t), t = !1)),
                                        t
                                }(e.shape || e.d || e.points || "", "d" === i, t), l && G.test(h)) return M("A <" + a + "> cannot accept path data. " + q),
                                !1;
                                if (c = e.shapeIndex || 0 === e.shapeIndex ? e.shapeIndex : "auto", g = e.map || J.defaultMap, this._prop = e.prop, this._render = e.render || J.defaultRender, this._apply = "updateTarget" in e ? e.updateTarget : J.defaultUpdateTarget, this._rnd = Math.pow(10, isNaN(e.precision) ? 2 : +e.precision), this._tween = n, h) {
                                        ...
                                        S && (this.add(this._origin, "x", this._origin.x, this._eOrigin.x, 0, 0, 0, 0, 0, 1), s = this.add(this._origin, "y", this._origin.y, this._eOrigin.y, 0, 0, 0, 0, 0, 1)),
                                        s && (this._props.push("morphSVG"), s.end = h, s.endProp = i)
                                }
                                return k
                        },
                        render: function render(t, e) {
                                for (var n, r, o, a, i, s, h, l, c, g, p, f, u = e._rawPath, d = e._controlPT, P = e._anchorPT, m = e._rnd, _ = e._target, v = e._pt; v;) v.r(t, v.d),
                                v = v._next;
                                if (1 === t && e._apply) for (v = e._pt; v;) v.end && (e._prop ? _[e._prop] = v.end : _.setAttribute(v.endProp, v.end)),
                                v = v._next;
                                else if (u) {
                                        for (; P;) i = P.sa + t * P.ca,
                                        a = P.sl + t * P.cl,
                                        ...
                                        P = P._next;
                                        for (r = t < .5 ? 2 * t * t : (4 - 2 * t) * t - 1; d;) f = (s = d.i) + (s === (o = u[d.j]).length - 4 ? 7 - o.length : 5),
